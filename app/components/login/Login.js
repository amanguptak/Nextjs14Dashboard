...
const Login = () => {
  return (
    <div>
      ...
      <div className="hidden lg:flex items-center justify-center bg-indigo-900 flex-1 h-screen">
          <div className="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
            ...
            >
              <title>Login</title>
              <rect y="17.06342" width={444} height={657} fill="#fff" />
              <polygon
                points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063"
                fill="#ea580c"
              />
              <circle cx={296} cy="377.06342" r={4} fill="#ea580c" />
              <polygon
              ...
              <circle cx={296} cy="346.06342" r={13} fill="#ffff" />
              <line
                x1="52.81943"
                y1="16.10799"
                x2="52.81943"
        ...
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div className="cursor-pointer flex items-center">
              ...
              <div className="text-2xl text-orange-600 tracking-wide ml-8 font-semibold">
                Admin-Aman
              </div>
            </div>
          </div>
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            <h2
              className="text-center text-4xl text-orange-600 font-display font-semibold lg:text-left xl:text-5xl
              xl:text-bold"
            >
              Log in
            </h2>
              ...
              <form action={authenticate}>
                ...
                <div className="mt-8">
                  <div className="flex justify-between items-center">
                    ...
                    {/* <div>
                      <a
                        className="text-xs font-display font-semibold text-orange-600 hover:text-orange-800
                                  cursor-pointer"
                      >
                        Forgot Password?
                      </a>
                ...
                <div className="mt-10">
                  <button
                    className="bg-orange-600 text-gray-100 p-4 w-full rounded-full tracking-wide
                          font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-orange-500
                          shadow-lg"
                  >
                    Log In
                  </button>
